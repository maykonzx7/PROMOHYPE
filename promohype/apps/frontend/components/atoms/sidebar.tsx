...
>(
  (
    ...
    // Seta o cookie quando o estado muda
    React.useEffect(() => {
...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="duration-200 relative h-svh w-[--sidebar-width] bg-transparent transition-all ease-linear"
        data-sidebar="sidebar"
      ...
      >
        ...
        {variant === "floating" || variant === "inset" ? (
          <button
            ...
            className="fixed inset-0 z-10 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 [&:not([data-state=closed])]:w-full [&:not([data-state=closed])]:cursor-default"
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:w-14"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-xl group-data-[variant=inset]:rounded-xl group-data-[variant=inset]:shadow-sm"
          >
            {children}
          </div>
        </div>
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className="flex h-8 items-center gap-2 rounded-md px-2 text-sidebar-foreground"
      {...props}
    >
      {showIcon && (
